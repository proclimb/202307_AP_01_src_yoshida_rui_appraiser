			...
			<table border="0" cellpadding="2" cellSpacing="0">
				<tr>
					...
					<td colspan="6">
						...
						<a class="txt-deco-none" href="javascript:cal1.write();" onChange="cal1.getFormValue(); cal1.hide();">
							<img src="./images/b_calendar.png">
						</a>
						<span id="cal1"></span>～
						<input type="text" name="sSearchTo" value="<?php print $param["sSearchTo"] ?>" size="15" />
						<a class="txt-deco-none" href="javascript:cal2.write();" onChange="cal2.getFormValue(); cal2.hide();">
							<img src="./images/b_calendar.png">
						</a>
						<span id="cal2"></span>
					</td>
